...
class OwlCarousel(CMSPlugin):
    ...
    carousel_interval = models.IntegerField(
        ...
        help_text=_('The amount of time to delay between automatically cycling '
                    'an item. If false, owlcarousel will not automatically cycle.'),
    )
    ...
    carousel_indicators = models.BooleanField(
        ...
        default=True,
        help_text=_('Adding in the indicators to the owlcarousel.'),
    )
    carousel_keyboard = models.BooleanField(
        verbose_name=_('Keyboard'),
        default=True,
        help_text=_('Whether the owlcarousel should react to keyboard events.'),
    )
    carousel_pause = models.CharField(
        ...
        max_length=255,
        help_text=_('If set to "hover", pauses the cycling of the owlcarousel on '
                    '"mouseenter" and resumes the cycling of the owlcarousel on '
                    '"mouseleave". If set to "false", hovering over the owlcarousel '
                    'won\'t pause it.')
    )
    carousel_ride = models.CharField(
        ...
        max_length=255,
        help_text=_('Autoplays the owlcarousel after the user manually cycles the '
                    'first item. If "owlcarousel", autoplays the owlcarousel on load.'),
    )
    carousel_wrap = models.BooleanField(
        verbose_name=_('Wrap'),
        default=True,
        help_text=_('Whether the owlcarousel should cycle continuously or have '
                    'hard stops.'),
    )
...
@python_2_unicode_compatible
class OwlCarouselSlide(AbstractLink, CMSPlugin):
