  ...
  (this.init = o || {
    ...
    (this.locale = {
      ...
      "cs-CS": {
        btn_open: "accessibility menu",
        btn_close: "zavřít",
        keyboard_root: "navigace pomocí kláves",
        disable_animattions: "blokovat animace",
        access_declaration: "deklarace přístupnosti webu",
        debug_contacts: "oznámení problému s přístupností",
        reset_all_settings: "reset nastavení",
        image_without_alt: "obrázek bez popisku",
        contrast_block: {
          header: "kontrastní barvy",
          btn_monochrome: "monochronní<br>displej",
          btn_bright: "zvýšit<br>kontrast",
          btn_invert: "inverzní<br>kontrast"
        },
        text_block: {
          header: "velikost textu",
          btn_font_up: "zvětšit<br>text",
          btn_font_down: "zmenšit<br>text",
          btn_font_readable: "čitelný<br>text"
        },
        content_block: {
          header: "zvýraznění obsahu",
          btn_underline_links: "podtrhnout<br>odkazy",
          btn_underline_headers: "podtrhnout<br>nadpisy",
          btn_images_titles: "titulky<br>obrázků"
        },
        zoom_block: {
          header: "zvětšení",
          btn_cursor_white: "velký bílý<br>kurzor",
          btn_cursor_black: "velký černý<br>kurzor",
          btn_zoom_in: "zvětšení<br>obrazovky"
        }
      }
    }),
  ...
  (MicAccessTool.prototype.buildToolBox = function() {
    var o = this.currentLanguage || this.locale.en,
      A =
        ...
        o.reset_all_settings +
        '"></button></div><div dir="ltr" class="mic-toolbox-all-credits"><span>learn more about</span>&nbsp;&nbsp;<a target="_blank" href="http://webworks.ga/acc_toolbar">toolbox</a></div></div>',
